...
import { Typography, Card, Table, Tag, Space, Empty, Modal, Button } from 'antd';
    ...
    <div style={{ padding: '24px' }}>
      ...
      <Card>
        <Space direction="vertical" size="large" style={{ width: '100%', marginBottom: 16 }}>
          ...
          <Card type="warning" style={{ backgroundColor: '#fff7e6', borderColor: '#ffd591' }}>
            <Space>
              <WarningOutlined style={{ color: '#faad14', fontSize: 20 }} />
              <span>
                <strong>Your account has been banned.</strong> You can only view and use your existing tickets. 
                You cannot purchase new tickets or transfer tickets.
              </span>
            </Space>
          </Card>
        </Space>
